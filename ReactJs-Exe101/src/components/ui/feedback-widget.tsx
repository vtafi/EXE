...
const EMOJIS = [
  {
    ...
    icon: (
      ...
      >
        ...
        <path d="M9 9h.01" />
        <path d="M15 9h.01" />
        <path d="M9 13v2" stroke="#f97316" />
        <path d="M15 13v2" stroke="#f97316" />
      </svg>
    ),
  },
  {
              ...
              {EMOJIS.map((emoji) => (
                <ToggleGroup.Item key={emoji.id} value={emoji.id} asChild>
                  <button
                    title={emoji.label}
                    className={cn(
                      "relative rounded-full p-2 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-orange-500",
                      value === emoji.id
                        ? "text-white"
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    className="relative rounded-xl bg-[#F97316] px-6 py-2 font-bold text-[13px] text-white transition-all hover:bg-orange-600 active:scale-95 disabled:pointer-events-none disabled:opacity-30 disabled:grayscale"
                  >
                    {isSubmitting ? (
                      <motion.div
                        animate={{ rotate: 360 }}
