...
const navItems = [
  { icon: "analytics", label: "Network Overview", path: "/admin" },
  { icon: "verified_user", label: "Cafe Approvals", path: "/admin/approvals" },
  { icon: "group", label: "User Database", path: "/admin/users" },
  { icon: "attach_money", label: "Financial Reports", path: "/admin/financial" },
  { icon: "gavel", label: "Dispute Hub", path: "#" },
  { icon: "campaign", label: "Marketing & Review", path: "/admin/marketing" },
